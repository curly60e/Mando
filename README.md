...
1. Download the Bin folder's file `Mando.ino.esp32.bin` onto the machine that you can connect your Watchy to by WiFi (laptop, cellphone, tablet, etc).
...
7. Press the `Choose File` button (right side of image above) then locate and select the `Mando.ino.esp32.bin` you downloaded in Step 1.
